...
### Added
- Locally deleted script files are moved to a `trash/` folder in the GitHub repo instead of being left orphaned or silently lost (toggle: `trashDeletedFiles`, default on)
